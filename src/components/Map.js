...
const Map = (props) => {
  ...
  const handleClick1 = (e) => {
    color1 === '#BF55F1' ? setColor1('#58DBF8') : setColor1('#BF55F1');
  };

  const handleClick2 = (e) => {
    setPolylineVisible(true);

    color2 === '#BF55F1' ? setColor2('#58DBF8') : setColor2('#BF55F1');
    props.sendBtnVisibility(true);
  };

  const handleClick3 = (e) => {
    color3 === '#FDBC15' ? setColor3('#58DBF8') : setColor3('#FDBC15');
  };

  const handleClick4 = (e) => {
    color4 === '#FDBC15' ? setColor4('#58DBF8') : setColor4('#FDBC15');
  };
  ...
  return isLoaded ? (
    ...
    >
      ...
      <Polygon
        ...
        options={
          (options,
          { fillColor: color1, strokeColor: color1, fillOpacity: 0.55 })
        }
      ...
      <Polygon
        ...
        options={
          (options,
          { fillColor: color2, strokeColor: color2, fillOpacity: 0.55 })
        }
      ...
      <Polygon
        ...
        options={
          (options,
          { fillColor: color3, strokeColor: color3, fillOpacity: 0.55 })
        }
      ...
      <Polygon
        ...
        options={
          (options,
          { fillColor: color4, strokeColor: color4, fillOpacity: 0.55 })
        }
        onClick={handleClick4}
      />
      <Marker icon={Lv2} position={textPositions[0]} />
      <Marker icon={Lv2} position={textPositions[1]} />
      <Marker icon={Lv1} position={textPositions[2]} />
      <Marker icon={Lv1} position={textPositions[3]} />
      <Polyline
        path={polylinePath}
      ...
      <Marker position={markerPosition} icon={currLocation} />
    </GoogleMap>
  ) : (
    <></>
  );
